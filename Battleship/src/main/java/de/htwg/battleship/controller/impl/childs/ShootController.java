 ...
 * @since 2014-11-19
 */
class ShootController extends Observable {
     ...
     */
    ShootController(final IPlayer player1, final IPlayer player2) {
     ...
     *
     * @param first if the board of the first or the second player should be
     *              returned
     *
     * @return IBoard
     */
