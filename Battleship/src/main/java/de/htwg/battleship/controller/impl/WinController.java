 ...
 * @since 2014-12-11
 */
class WinController extends Observable {
    ...
    /**
     * Saves the Chain-of-Responsibility. Checks if a Ship is destroyed.
     */
    private final DestroyedController dc;

    /**
     * Public Constructor. Initializes intern Chain-of-Responsibility.
     *
     * @param player1 first Player
     * @param player2 second Player
     */
    WinController(final IPlayer player1, final IPlayer player2) {
    ...
    /**
     * Private Utility-Method to pass the responsibility to the chain. The chain
